...
public class Deska extends JPanel {
    ...
    private void initBoard(Tetris parent,InfoDisplay display) {
        ...
        display.setVišinaKvadrata(višinaKvadrata());
        display.setŠirinaKvadrata(širinaKvadrata());
    }
    ...
    private void pause() {
        ...
        if (jaPavza) {
            ...
            statusbar.setText(String.valueOf(štOdstranjenihVrstic));
        }
        repaint();
    }
    ...
    private void removeFullLines() {
        ...
        if (numFullLines > 0) {
            ...
            statusbar.setText(String.valueOf(štOdstranjenihVrstic+"  Naslednji:"+naslednjiLik.getLik()+"  Shranjen:"+shranjenLik.getLik()));
            jeKonecPada = true;
            trenutniLik.nastaviLik(Liki.NoShape);
        }
    }
    ...
    private void doGameCycle() {
        update();
        repaint();
        display.update(naslednjiLik,shranjenLik);
    }
